...
import { FlatList, ScrollView, Text, View, TouchableOpacity, Image, Dimensions, TouchableHighlight, Alert, Vibration, Platform } from 'react-native';
...
export default class RecipeScreen extends React.Component {
   ...
   orderSuccess = (order) => {
      ...
      let user = App.db
         .ref('users/6GX8plM7xQUdikbbIi3bpsGqDUI3')
         .once('value')
   ...
   render() {
      ...
      const submitOrderHandler = (contactInfo) => {
         App.db
            .ref(`orders/`)
            .push({ orderedItem: item, contactInfo: contactInfo })
            .then(
               () =>
                  this.orderSuccess({
                     ...contactInfo,
